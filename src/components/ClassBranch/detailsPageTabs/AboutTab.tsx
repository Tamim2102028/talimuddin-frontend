...
const AboutTab: React.FC<Props> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Branch Stats */}
      <div>
        <h3 className="mb-3 font-bold text-gray-900">Branch Stats</h3>
          ...
          <div className="space-y-2 rounded-lg border border-gray-200 bg-gray-50 p-4">
            ...
            {Branch.year && (
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-gray-900">{Branch.year}</span>
              </div>
            )}
            {Branch.semester && (
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-gray-900">{Branch.semester}</span>
              </div>
            )}
            {Branch.section && (
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-gray-900">{Branch.section}</span>
              </div>
            )}
            {Branch.subsection && (
              <div className="flex items-center justify-between">
      ...
      {Branch.lastActivityAt && (
        <div>
          ...
          <p className="text-gray-700">
            {new Date(Branch.lastActivityAt).toLocaleDateString("en-US", {
              year: "numeric",
              month: "long",
              day: "numeric",
            })}
