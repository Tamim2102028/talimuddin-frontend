      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-6 rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
          <div className="mb-4 flex items-center">
            <div className="mr-4 inline-flex h-16 w-16 items-center justify-center rounded-lg bg-red-100">
              <FaLink className="h-8 w-8 text-red-600" />
            </div>
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                Student Portal
              </h1>
              <p className="text-gray-600">Access student services</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <p className="leading-relaxed text-gray-600">
            This section will provide access to student services, administrative
            tools, and university portals.
          </p>
        </div>
      </div>
    </div>
