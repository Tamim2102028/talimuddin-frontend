      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-6 rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
          <div className="mb-4 flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-600">Navigate the university campus</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <p className="leading-relaxed text-gray-600">
            This section will provide an interactive campus map, building
            locations, and navigation assistance.
          </p>
        </div>
      </div>
    </div>
